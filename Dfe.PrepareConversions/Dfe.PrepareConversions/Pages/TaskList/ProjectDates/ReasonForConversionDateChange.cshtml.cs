...
public class ReasonForConversionDateChangePageModel : BaseAcademyConversionProjectPageModel
{
   ...
   public override async Task<IActionResult> OnPostAsync(int id)
   {
      ...
      var projectDatesModel = new SetProjectDatesModel(id, Project.HeadTeacherBoardDate, Project.PreviousHeadTeacherBoardDate, ConversionDate, Project.ProjectDatesSectionComplete, User.Identity.Name, MapSelectedReasons(), sfsoCommissioningRequestedDate: Project.SfsoCommissioningRequestedDate);
   ...
   private IEnumerable<ReasonChange> MapSelectedReasons()
   {
      ...
      else
      {
         ...
         .Select(reason => reason switch
         {
            ...
            ConversionDateReasonForChangeFuture.Finance => new ReasonChange(reason.ToDescription(), ChangeFinanceReason),
            ConversionDateReasonForChangeFuture.Governance => new ReasonChange(reason.ToDescription(), ChangeGovernanceReason),
