   ...
   public static class PublicSectorEqualityDutyGenerator
   {
      public static void AddPublicSectorEqualityDuty(DocumentBuilder builder, ProjectTemplateModel projectTemplateModel)
      {
         builder.ReplacePlaceholderWithContent("PublicEqualityDuty", build =>
         {
            ...
            {
               DocumentGeneratorStringSanitiser.CreateTextElements("Public Sector Equality Duty consideration", projectTemplateModel.PublicEqualityDutyImpact),
               DocumentGeneratorStringSanitiser.CreateTextElements("What will be done to reduce this impact?", projectTemplateModel.PublicEqualityDutyReduceImpactReason),
            };
