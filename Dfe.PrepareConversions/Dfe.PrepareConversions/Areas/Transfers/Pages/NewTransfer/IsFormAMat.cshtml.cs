...
namespace Dfe.PrepareConversions.Areas.Transfers.Pages.NewTransfer
{
    public class IsFormAMatModel : PageModel
    {
        ...
        public IActionResult OnPost() 
        {
            ...
            var redirectPage = IsFormAMatViewModel.IsFormAMat.HasValue && IsFormAMatViewModel.IsFormAMat.Value ? "/NewTransfer/ProposedTrustName" : "/NewTransfer/PreferredTrust";
