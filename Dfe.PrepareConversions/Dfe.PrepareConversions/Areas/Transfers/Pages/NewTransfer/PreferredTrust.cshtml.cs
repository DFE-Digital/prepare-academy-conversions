...
namespace Dfe.PrepareTransfers.Web.Pages.Transfers
{
    public class PreferredTrustModel : PageModel
    {
        ...
        public IActionResult OnPost() 
        {
            ...
            var redirectPage = PreferredTrustViewModel.HasPreferredTrust.HasValue && PreferredTrustViewModel.HasPreferredTrust.Value ? "/NewTransfer/IncomingTrust" : "/NewTransfer/checkyouranswers";
