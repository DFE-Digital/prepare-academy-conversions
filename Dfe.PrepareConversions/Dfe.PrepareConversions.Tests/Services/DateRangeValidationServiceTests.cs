...
public class DateRangeValidationServiceTests
{
   ...
   public class Past : DateRangeValidationServiceTests
   {
      ...
      {
         (bool, string) result = _validator.Validate(PastDate, DateRangeValidationService.DateRange.Past, "Input");
   ...
   public class PastOrToday : DateRangeValidationServiceTests
   {
      ...
      {
         (bool, string) result = _validator.Validate(PastDate, DateRangeValidationService.DateRange.PastOrToday, "Past or today");
      ...
      {
         (bool, string) result = _validator.Validate(DateTime.Today, DateRangeValidationService.DateRange.PastOrToday, "Past or today");
