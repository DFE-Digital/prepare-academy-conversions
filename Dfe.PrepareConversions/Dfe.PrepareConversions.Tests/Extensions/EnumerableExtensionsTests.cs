...
public class EnumerableExtensionsTests
{
   public static IEnumerable<TestClass> DataWithDuplicatesForEnumerableTests
   {
      get
      {
         List<TestClass> listWithDuplicate = new()
         {
            new() { Property1 = "Test1", Property2 = "Test2" },
            new() { Property1 = "Test1", Property2 = "Test1" },
            new() { Property1 = "Test2", Property2 = "Test3" },
            new() { Property1 = "Test3", Property2 = "Test4" }
         };
   ...
   public static IEnumerable<TestClass> DataForEnumerableTests
   {
      get
      {
         List<TestClass> listWithDuplicate = new()
         {
            new() { Property1 = "Test1", Property2 = "Test2" },
            new() { Property1 = "Test2", Property2 = "Test3" },
            new() { Property1 = "Test4", Property2 = "Test5" },
            new() { Property1 = "Test6", Property2 = "Test7" }
         };
         return listWithDuplicate;
      }
   }
