...
namespace Dfe.PrepareConversions.Data.Models.KeyStagePerformance
{
	public class KeyStagePerformance
	{
		...
		private static bool HasKeyStage2Performance(KeyStage2PerformanceResponse keyStage2Performance)
		{
		...
		private static bool HasKeyStage4Performance(KeyStage4PerformanceResponse keyStage4Performance)
		{
		...
		private static bool HasKeyStage5Performance(KeyStage5PerformanceResponse keyStage5Performance)
		{
		...
		private static bool HasValue(DisadvantagedPupilsResponse disadvantagedPupilsResponse)
		{
