   ...
   it('Creating a conversion project and recording a new decision then editing the decision', () => {
      ...
      cy.url()
         ...
         .then(() => {
            ...
            Logger.log(
               'Click on record a decision button and add a decision to check error handling'
            );
            ...
            Logger.log(
               'Verify that decision was recorded successfully then change the decision details, verify the changes'
            );
            decisionPage.changeDecisionDetails();

            Logger.log(
               'Change the current decision to DAO (Directive Academy Order) revoked and verify the changes'
            );
