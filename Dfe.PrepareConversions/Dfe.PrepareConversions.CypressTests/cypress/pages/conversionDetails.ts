...
export default class ConversionDetails extends BasePage {
  static selectors = {
    ...
    fundingAmountDefaultYesRadio:
      '[name="conversion-support-grant-amount-changed"][data-cy="select-radio-yes"]',
    fundingAmountDefaultNoRadio:
      '[name="conversion-support-grant-amount-changed"][data-cy="select-radio-no"]',
    ...
    EIGYesRadio:
      '[name="conversion-support-grant-environmental-improvement-grant"][data-cy="select-radio-yes" i]',
    EIGNoRadio:
      '[name="conversion-support-grant-environmental-improvement-grant"][data-cy="select-radio-no" i]',
  ...
  static setPreviousAdvisoryBoardDate(
    previousBoard = true,
    date: Date = today
  ): void {
    cy.checkPath(this.path);
