...
export default class ConversionDetails extends BasePage {
    static selectors = {
        ...
        advisoryBoardDateLink: '[data-test="change-proposed-decision-date"]',
        advisoryBoardDateValue: '[id="proposed-decision-date"]',
        ...
        previousAdvisoryBoardLink: '[data-test="change-previously-considered-on"]',
        previousAdvisoryBoardValue: '[id="previously-considered-on"]',
