      ...
      School academisationApplicationSchool = new()
      {
         Leases = new List<Lease>
         {
            new()
            {
               ...
               PaymentsToDate = (decimal)2.5,
               ResponsibleForAssets = "School",
               ValueOfAssets = "5000",
               LeaseTerm = "36"
            },
            new()
            {
               ...
               PaymentsToDate = (decimal)2.5,
               ResponsibleForAssets = "Landlord",
               ValueOfAssets = "10000",
               LeaseTerm = "48"
            }
         }
      };
      ApplyingSchool academiesApplicationSchool = new() { SchoolLeases = new List<Data.Models.Application.Lease>() };
