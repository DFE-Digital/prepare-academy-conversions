...
namespace Dfe.PrepareConversions.Data.Tests.Services
{
	public class HttpClientServiceTests
	{
			...
			AdvisoryBoardDecision decision)
		{
			...
			var sut = new HttpClientService(new MockHttpClientFactory(mockHandler), logger.Object);

			var result = await sut.Post<AdvisoryBoardDecision, AdvisoryBoardDecision>(path, decision);
			...
			AdvisoryBoardDecision decision)
		{
			...
			var sut = new HttpClientService(new MockHttpClientFactory(mockHandler), logMock.CreateLogger<HttpClientService>());

			await sut.Post<AdvisoryBoardDecision, AdvisoryBoardDecision>(path, decision);
			...
			AdvisoryBoardDecision decision)
		{
			...
			var result = await sut.Get<AdvisoryBoardDecision>(path);
		...
		public async Task Should_log_when_response_not_successful_on_get([Frozen] MockHttpMessageHandler mockHandler)
		{
			...
			await sut.Get<AdvisoryBoardDecision>(path);
			...
			AdvisoryBoardDecision decision)
		{
			...
			var result = await sut.Put<AdvisoryBoardDecision, AdvisoryBoardDecision>(path, decision);
			...
			AdvisoryBoardDecision decision)
		{
			...
			await sut.Put<AdvisoryBoardDecision, AdvisoryBoardDecision>(path, decision);
