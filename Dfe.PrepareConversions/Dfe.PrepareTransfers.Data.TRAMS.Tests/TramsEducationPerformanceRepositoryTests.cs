...
using Xunit;
using EducationPerformance = Dfe.PrepareTransfers.Data.Models.KeyStagePerformance.EducationPerformance;
...
namespace Dfe.PrepareTransfers.Data.TRAMS.Tests
{
    public class TramsEducationPerformanceRepositoryTests
    {
        ...
        public TramsEducationPerformanceRepositoryTests()
        {
            ...
            _subject = new TramsEducationPerformanceRepository( _mapper.Object, _distributedCache);
        }
