    ...
    public class TramsProjectsRepositoryTests
    {
        ...
        public TramsProjectsRepositoryTests()
        {
            ...
            _subject = new TramsProjectsRepository(null,
                 _externalToInternalMapper.Object, _summaryToInternalMapper.Object,
        ...
        public class CreateProjectTests : TramsProjectsRepositoryTests
        {
            ...
            {
                _projectToCreate = new Project {Status = "New", OutgoingTrustUkprn = "10059868", TransferringAcademies = new List<Data.Models.Projects.TransferringAcademy>() { 
                    new Data.Models.Projects.TransferringAcademy() { OutgoingAcademyUkprn = "10066875", IncomingTrustUkprn = "10059612", IncomingTrustName = "Test Trust 1" },
                    new Data.Models.Projects.TransferringAcademy() { OutgoingAcademyUkprn = "10066884", IncomingTrustUkprn = "10059612", IncomingTrustName = "Test Trust 2" }} };
