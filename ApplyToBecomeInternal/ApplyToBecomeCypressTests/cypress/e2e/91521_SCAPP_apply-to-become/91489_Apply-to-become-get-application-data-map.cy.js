...
describe('91489: Apply-to-becom GET data application types', { tags: ['@dev', '@stage']}, () => {
	...
	beforeEach(() => {
		...
		cy.visit(Cypress.env('url') + '/school-application-form/17')
	})
	...
	it('TC08: Additional Details', () => {
		...
		var expectedDateString = new Date(dataAppSch.schoolSACREExemptionEndDate).toLocaleDateString('en-GB', {
			year: 'numeric',
			month: 'long',
			day: 'numeric'
		})
	...
	it('TC16: Land & Buildings Details', () => {
		...
		var expectedDateString = new Date(dataAppSch.schoolBuildLandWorksPlannedCompletionDate).toLocaleDateString('en-GB', {
			year: 'numeric',
			month: 'long',
			day: 'numeric'
		})
