...
namespace ApplyToBecomeInternal.Tests.Models.ApplicationForm.Overview
{
	public class FurtherInformationSectionTabTests
	{
		...
		public void Constructor_Doesnt_Set_Conditional_Rows_Following_No_Answers()
		{
			...
			var expectedFields = new[] {
				...
				new FormField("Is your school linked to a diocese?", "No"),
				new FormField("Name of diocese?", application.SchoolFaithSchoolDioceseName),
				new LinkFormField("Upload a letter of consent from the diocese","Diocese consent document", application.DiocesePermissionEvidenceDocumentLink),				
			...
			var formSection = new FurtherInformationSectionTab(application);
