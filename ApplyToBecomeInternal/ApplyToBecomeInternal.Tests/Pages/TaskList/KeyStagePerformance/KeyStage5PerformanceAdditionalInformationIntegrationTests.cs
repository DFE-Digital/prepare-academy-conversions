...
namespace ApplyToBecomeInternal.Tests.Pages.KeyStagePerformance
{
	public class KeyStage5PerformanceAdditionalInformationTests
	{
		...
		{
			public KeyStage5PerformanceAdditionalInformationIntegrationTests(IntegrationTestingWebApplicationFactory factory, ITestOutputHelper outputHelper) : base(factory, outputHelper) { }
			...
			public async Task Should_navigate_to_and_update_additional_information()
			{
				...
				var request = AddPatchProject(project, r => r.KeyStage5PerformanceAdditionalInformation);
