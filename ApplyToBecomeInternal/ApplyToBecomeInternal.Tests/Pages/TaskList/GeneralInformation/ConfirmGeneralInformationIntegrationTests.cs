...
namespace ApplyToBecomeInternal.Tests.Pages.GeneralInformation
{
	...
	{
		public ConfirmGeneralInformationIntegrationTests(IntegrationTestingWebApplicationFactory factory, ITestOutputHelper outputHelper) : base(factory, outputHelper) { }
