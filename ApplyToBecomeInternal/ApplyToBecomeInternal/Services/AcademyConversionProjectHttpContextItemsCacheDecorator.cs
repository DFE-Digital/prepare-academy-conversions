...
{
	public class AcademyConversionProjectHttpContextItemsCacheDecorator : IAcademyConversionProjectRepository
	{
		private readonly IAcademyConversionProjectRepository _innerRepository;
		private readonly HttpContext _httpContext;

		public AcademyConversionProjectHttpContextItemsCacheDecorator(IAcademyConversionProjectRepository innerRepository, IHttpContextAccessor httpContextAccessor)
		{
			_innerRepository = innerRepository;
			_httpContext = httpContextAccessor.HttpContext;
		}

		public Task<ApiResponse<IEnumerable<AcademyConversionProject>>> GetAllProjects()
		{
			return _innerRepository.GetAllProjects();
		}
