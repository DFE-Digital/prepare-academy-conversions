	...
	public class UpdateAcademyConversionProjectPageModel : BaseAcademyConversionProjectPageModel
	{
		...
		private UpdateAcademyConversionProject Build()
		{
			return new UpdateAcademyConversionProject
			{
				...
				RationaleSectionComplete = AcademyConversionProject.RationaleSectionComplete,// ?? AcademyConversionProject.RationaleSectionCompleteHidden,
				RisksAndIssues = AcademyConversionProject.RisksAndIssues,
				RisksAndIssuesSectionComplete = AcademyConversionProject.RisksAndIssuesSectionComplete,// ?? AcademyConversionProject.RisksAndIssuesSectionCompleteHidden,
