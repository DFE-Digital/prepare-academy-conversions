...
{
	public class ConfirmProjectAndTrustRationalePageModel : BaseProjectPageModel
	{
		public ConfirmProjectAndTrustRationalePageModel(AcademyConversionProjectRepository repository) : base(repository) { }
