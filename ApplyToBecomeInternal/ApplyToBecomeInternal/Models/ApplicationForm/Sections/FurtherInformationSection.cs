	...
	public class FurtherInformationSection : BaseFormSection
	{
		...
		private IEnumerable<FormField> GenerateFields(Application application) =>
			new[]
			{
				...
				new FormField("Are there any safeguarding investigations ongoing at the school?", application.SchoolAdSafeguarding.ToYesNoString()),
				new FormField("Is the school part of a local authority reorganisation?", application.SchoolLaReorganization.ToYesNoString()),
				new FormField("Is the school part of any local authority closure plans?", application.SchoolLaClosurePlans.ToYesNoString()),
				...
				new LinkFormField("Upload a letter of consent from the diocese", new Link("link_name","#")),
				new FormField("Is your school part of a federation?", application.SchoolPartOfFederation.ToYesNoString()),
				new FormField("Is the school supported by a foundation, trust or other body (e.g. parish council) that appoints foundation governors?", application.SchoolSupportedFoundation.ToYesNoString()),
				new FormField(
					...
					application.SchoolSACREExemption.ToYesNoString()),
				...
				new LinkFormField(
					...
					new Link("link_name","#")),
				new FormField("Has an equalities impact assessment been carried out and considered by the governing body?", application.SchoolAdEqualitiesImpactAssessment.ToYesNoString()),
				new FormField("Do you want to add any further information?","needs mapping")
			};
	}
}