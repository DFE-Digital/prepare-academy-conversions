...
{
	public class FurtherInformationSectionTab : BaseFormSection
	{
		public FurtherInformationSectionTab(ApplyingSchool application) : base("Further information") =>
		...
		private IEnumerable<FormField> GenerateFields(ApplyingSchool application) =>
			new[]
			{
				...
				new LinkFormField("Upload a letter of consent from the diocese", new Link("Diocese consent document", application.DiocesePermissionEvidenceDocumentLink)),
