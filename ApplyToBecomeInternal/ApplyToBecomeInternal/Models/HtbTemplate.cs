	...
	public class HtbTemplate
	{
			...
			KeyStagePerformance keyStagePerformance)
		{
			var htbTemplate = new HtbTemplate
			{
				...
				YearOneProjectedCapacity = project.YearOneProjectedPupilNumbers.ToString(),
				YearOneProjectedPupilNumbers = project.ProjectedPupilNumbersYear1.ToStringOrDefault(),
				YearOnePercentageSchoolFull = project.ProjectedPupilNumbersYear1.AsPercentageOf(project.YearOneProjectedPupilNumbers),
