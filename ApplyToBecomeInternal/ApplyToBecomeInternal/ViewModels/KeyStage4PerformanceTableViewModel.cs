namespace ApplyToBecomeInternal.ViewModels
{
	public class KeyStage4PerformanceTableViewModel
	{
		...
		public string NationalAverageProgress8PupilsIncluded { get; set; }
		public string NationalAverageProgress8PupilsIncludedPreviousYear { get; set; }
		public string NationalAverageProgress8PupilsIncludedTwoYearsAgo { get; set; }
